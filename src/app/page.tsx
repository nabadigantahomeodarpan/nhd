    ...
    <main className="w-full bg-background flex flex-col relative overflow-x-hidden text-foreground">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            {isLoggedIn ? (
              <Link
                ...
                className="inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground hover:bg-primary/90 h-9 px-4 sm:h-10 sm:px-6 gap-2 shrink-0 whitespace-nowrap text-sm sm:text-base font-medium transition-colors"
              >
                Dashboard
              </Link>
            ) : (
      ...
      <section className="w-full py-12 sm:py-16 md:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 xl:gap-12 items-center">
            ...
            <StaggerContainer className="space-y-6 md:space-y-8 z-10 max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
              <StaggerItem>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.15]">
                  ...
                  <br />
                  is health{" "}
                  <span className="inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 bg-foreground text-background rounded-full mx-1 md:mx-2 -translate-y-1">
                    <ArrowRight className="w-4 h-4 md:w-5 md:h-5 -rotate-45" />
                  </span>{" "}
                  <br className="hidden md:block" />
                  <span className="font-[family-name:--font-playfair] italic text-primary">
                    over everything
                  </span>
                </h1>
              </StaggerItem>
              ...
              <StaggerItem>
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-md mx-auto lg:mx-0">
                  Choosing health above all is a smart investment in your
                  future. When you prioritize your well-being more smoothly.
                </p>
              </StaggerItem>
              ...
              <StaggerItem>
                <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-3 sm:gap-4 pt-2 w-full">
                  ...
                  <Button
                    variant="outline"
                    className="h-12 px-8 text-base rounded-lg gap-2 shrink-0 whitespace-nowrap group bg-transparent border-primary/20 hover:bg-primary/10 w-full sm:w-auto"
                  >
                    Learn More{" "}
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                  </Button>
            ...
            <ScaleIn
              delay={0.2}
              className="relative w-full h-[350px] sm:h-[400px] md:h-[450px] lg:h-[500px] xl:h-[550px] rounded-2xl md:rounded-3xl bg-[url('/hero-bg.webp')] bg-cover bg-center bg-no-repeat z-0 border border-border shadow-sm"
            >
              ...
              <div className="absolute -top-4 -left-2 sm:-top-8 sm:-left-8 md:-top-12 md:-left-12 lg:-top-16 lg:-left-16 w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 lg:w-36 lg:h-36 z-20 pointer-events-none select-none">
                <div className="w-full h-full animate-spin-slow relative">
                  ...
                  <svg
                    viewBox="0 0 100 100"
                    className="w-full h-full fill-foreground font-medium text-[10px] md:text-[11px] tracking-[0.2em] uppercase"
                  >
                    <path
                      id="circlePath"
              ...
              <SlideLeft
                delay={0.5}
                className="absolute -bottom-4 right-2 sm:-bottom-8 sm:-right-4 lg:-bottom-10 lg:-right-10 bg-card/95 backdrop-blur-md rounded-xl p-3 md:p-4 lg:p-5 shadow-lg border border-border/60 max-w-[180px] sm:max-w-[200px] md:max-w-[240px] z-20"
              >
                <h3 className="text-[11px] sm:text-xs md:text-sm font-semibold mb-2 md:mb-3 leading-tight">
                  Latest Visited Patients
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SlideUp className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-muted-foreground text-base md:text-lg">
              We offer a range of natural treatments to help you feel your best.
              Here is what you can expect when you visit our clinic.
            </p>
          </SlideUp>
          ...
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <StaggerItem>
              <div className="bg-card border border-border/60 rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-md hover:border-primary/40 transition-all group h-full">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Sit down with our experienced doctors to talk about your
                  health. We take the time to understand your unique needs and
            ...
            <StaggerItem>
              <div className="bg-card border border-border/60 rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-md hover:border-primary/40 transition-all group h-full">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Get safe, high-quality homeopathic medicines directly from our
                  clinic. We use natural remedies that work with your body, not
                  against it.
                </p>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="bg-card border border-border/60 rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-md hover:border-primary/40 transition-all group h-full">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Chronic illnesses need time and patience. We offer steady,
                  ongoing support to help you manage long-term conditions and
            ...
            <StaggerItem>
              <div className="bg-card border border-border/60 rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-md hover:border-primary/40 transition-all group h-full">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Medicine is just one part of healing. We will guide you on the
                  right food and daily habits to keep you healthy and energized
                  naturally.
                </p>
              </div>
            </StaggerItem>
            ...
            <StaggerContainer className="order-1 lg:order-2 space-y-6 md:space-y-8">
              ...
              <StaggerItem>
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  We believe that true healing comes from within. Instead of
                  just masking your symptoms with temporary fixes, our approach
                  focuses on curing the illness at its root. We are here to
                  listen, understand, and guide you on your journey to better
                  health.
                </p>
              </StaggerItem>
      ...
      <section className="w-full py-16 md:py-24 bg-primary/5 border-y border-primary/10 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SlideUp className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-muted-foreground text-base md:text-lg">
              Don't just take our word for it. Read the real stories from people
              who have found relief and better health at our clinic.
            </p>
          </SlideUp>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <StaggerItem>
              <div className="bg-card border border-border/60 rounded-2xl p-6 md:p-8 shadow-sm flex flex-col relative h-full">
                ...
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed flex-1 mb-6">
                  "I have been visiting Nabadiganta for a year now. The doctors
                  are incredibly patient and my chronic migraines are almost
                  completely gone. Highly recommended!"
                </p>
            ...
            <StaggerItem>
              <div className="bg-card border border-border/60 rounded-2xl p-6 md:p-8 shadow-sm flex flex-col relative h-full">
                ...
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed flex-1 mb-6">
                  "The clinic is very clean, and the staff makes you feel at
                  home. I love how they explain exactly what the medicine does
                  instead of just handing out pills."
                </p>
                <div className="flex items-center gap-3">
                  <Avatar className="w-10 h-10 border border-border">
            ...
            <StaggerItem>
              <div className="bg-card border border-border/60 rounded-2xl p-6 md:p-8 shadow-sm flex flex-col relative h-full">
                ...
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed flex-1 mb-6">
                  "Finally found a place that treats the root cause. The natural
                  medicines have worked wonders for my son's allergies when
                  nothing else did."
                </p>
                <div className="flex items-center gap-3">
                  <Avatar className="w-10 h-10 border border-border">
      ...
      <footer className="w-full bg-card border-t border-border pt-16 pb-8 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
            ...
            <StaggerItem className="lg:col-span-2 space-y-4">
              ...
              <p className="text-sm text-muted-foreground max-w-sm leading-relaxed">
                Your trusted partner in natural and holistic healing. We provide
                expert homeopathic care tailored to your unique body and
                lifestyle.
              </p>
            </StaggerItem>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-muted-foreground">
                    Beldanga New Hospital Road , 742133
                  </span>
                </li>
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-muted-foreground">
                    nabadigantahomeodarpan@gmail.com
                  </span>
                </li>
              </ul>
            </StaggerItem>
          ...
          >
            <p className="text-xs text-muted-foreground">
              © {new Date().getFullYear()} Nabadiganta Homeo Darpan. All rights
              reserved.
            </p>
            <div className="flex items-center">
              ...
              >
                <div className="flex items-center h-8 px-4 rounded-full bg-primary/10 hover:bg-primary/15 border border-primary/20 text-xs font-medium text-foreground transition-colors z-10 relative">
                  Build with{" "}
                  <Heart className="w-3.5 h-3.5 mx-1.5 text-primary fill-primary animate-pulse" />{" "}
                  dgisight
                </div>
